...
const styles = StyleSheet.create({
  ...
  rentalBadgeText: { color: '#1D4ED8', fontSize: 10, fontWeight: '700' },
  body: { paddingTop: 10, paddingHorizontal: 11, paddingBottom: 12, gap: 3 },
  name: { fontSize: 13.5, fontWeight: '700', lineHeight: 18, color: '#000000' },
  meta: { fontSize: 11, color: '#000000' },
  metaFlex: { flex: 1 },
  price: { fontSize: 16, fontWeight: '800', color: '#000000', letterSpacing: -0.2, marginTop: 2 },
