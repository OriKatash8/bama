  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.infoSquare}>
        <View style={styles.infoOuterRow}>
          {/* LEFT: View Profile button */}
          ...
          {/* RIGHT: professional info + avatar */}
          <View style={styles.infoRow}>
            <View style={styles.infoCol}>
              {projectTitle && (
                <Text style={[styles.projectTitle, { fontFamily: font.regular }]} numberOfLines={1} ellipsizeMode="tail">
                  {t('offers.for_project')}{projectTitle}
                </Text>
              )}
              <Text style={[styles.name, { fontFamily: font.bold }]} numberOfLines={1} ellipsizeMode="tail">
                {displayName}
              </Text>
              <Text style={[styles.role, { fontFamily: font.regular }]} numberOfLines={1} ellipsizeMode="tail">
                {offer.subcategory}
              </Text>
